...
export const SCANNER_COPY: Record<ScannerState, ScannerCopy> = {
  ...
  match_high: {
    ...
    subtext: "We found the closest match based on cover, title, and layout.",
    primaryButton: "Confirm & Continue",
    secondaryButton: "Edit Details",
    tertiaryButton: "Not the right book?",
  },
  match_medium: {
    header: "Possible Match Found",
    subtext: "Some details may be off — quick confirmation helps improve accuracy.",
    primaryButton: "Review Match",
    secondaryButton: "Search Manually",
  },
  match_low: {
    header: "We're Still Learning This One",
    subtext: "Add details manually — we'll remember this for next time.",
    primaryButton: "Add Details (30 sec)",
    secondaryButton: "Try Another Photo",
    helperText: "Flat cover photos work best",
  },
  multi_match: {
    header: "Select the Best Match",
    subtext: "Choose the closest option — you can edit details next.",
    primaryButton: "Select This Match",
    tertiaryButton: "None of These — Enter Manually",
  },
  confirm: {
