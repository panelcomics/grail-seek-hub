        ...
        {discount ? (
          <>
            ...
            <div className="space-y-2">
              ...
              {usagePercentage >= 90 && (
                <div className="flex items-start gap-2 text-xs text-amber-600">
                  ...
                  <span>
                    You're approaching your monthly discount cap. Standard 6.5% selling fee (including payment processing) will apply once the cap is reached.
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="pt-4 border-t text-xs text-muted-foreground">
              Your discount code reduces seller fees from 6.5% (including payment processing) to {discount.discountRate}% on nationwide shipping, with a maximum of ${discount.monthlyCap} in monthly savings.
            </div>
          </>
        ) : (
          <>
