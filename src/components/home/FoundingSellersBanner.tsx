...
export function FoundingSellersBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary/90 via-primary to-primary/90 text-primary-foreground py-0.5 sm:py-1.5 px-3 sm:px-4 relative overflow-hidden">
