      ...
      <section className="relative py-4 sm:py-6 md:py-8 px-4 overflow-hidden bg-gradient-to-b from-[hsl(30,15%,97%)] to-[hsl(30,10%,94%)]">
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="flex flex-col lg:flex-row gap-6 md:gap-10 items-center">
            ...
            <div className="w-full lg:w-1/2 space-y-4 md:space-y-5 flex flex-col">
              {/* Headline and subheadline - order 1 on mobile */}
              <div className="order-1">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.2] sm:leading-[1.15] mb-3 md:mb-4">
                ...
                <div className="flex flex-wrap gap-3 md:gap-4 py-3 text-muted-foreground">
              ...
              <div className="order-2 lg:hidden -mx-4 sm:mx-0">
                <div className="relative rounded-none sm:rounded-2xl overflow-hidden shadow-2xl">
                  <img
                    ...
                    className="w-full h-[280px] sm:h-96 object-cover object-center"
                  />
                </div>
              </div>
          ...
          <div className="order-3 w-full lg:w-auto lg:mt-8 md:mt-12">
