/**
 * SCANNER MATCH HIGH CONFIDENCE SCREEN
 * ==========================================================================
 * Best Match Found - confidence >= 0.80
 * ==========================================================================
 */
...
interface ScannerMatchHighScreenProps {
  match: ComicVinePick;
...
export function ScannerMatchHighScreen({
  match,
  previewImage,
  onConfirm,
  onEdit,
  onNotRight,
}: ScannerMatchHighScreenProps) {
  const copy = SCANNER_COPY.match_high;
